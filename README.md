...
npm i
```
to install the dependencies for the downloader. There's only one, that being `archiver` to package the assets and json into a final zip file, because SB3 files are just renamed zip files.
